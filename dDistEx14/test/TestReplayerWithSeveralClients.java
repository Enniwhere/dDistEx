...
public class TestReplayerWithSeveralClients {
    ...
    @Test
    public void severalInsertsAndARemoveFromSeveralClientsOnDifferentOffsetsShouldGiveIntuitiveResultsAltClientExtraEvent(){
        setUpAlt("client3");
        ...
        timestamp.put("client4", 2);
        insert4_1.setTimestamp(new HashMap<String, Integer>(timestamp));
        MyTextEvent insert4_3 = new TextInsertEvent(3+5+5,"(4_3)");
        insert4_3.setSender("client4");
        timestamp.put("client1", 1);
        timestamp.put("client4", 3);
        insert4_3.setTimestamp(new HashMap<String, Integer>(timestamp));

        inputQueue.add(insert2_0);
        inputQueue.add(insert2_3);
        inputQueue.add(insert4_3);
        inputQueue.add(insert4_1);
        inputQueue.add(insert1_3);
        ...
        assertEquals("Text after inserting the events should be (2_0)a(1_1)(1_3)(2_3)(4_3)d(4_4)", "(2_0)a(1_1)(1_3)(2_3)(4_3)d(4_4)", area1.getText());
